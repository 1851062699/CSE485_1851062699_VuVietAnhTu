    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Resume CV</a>
    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        ...
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/default.jpeg" alt="Image"/></a></div>
          <?php
            echo '<div class="h2 title">'.$post[0].'</div>';
          ?>
          <p class="category text-white"><?php echo $post[1]; ?></p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="https://github.com/1851062699/CSE485_1851062699_VuVietAnhTu" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
        <?php
          }
        ?>
  ...
  <div class="container">
    <div class="card" data-aos="fade-up" data-aos-offset="10">
      <div class="row">
        ...
        <?php
          include('connectdb.php');
          $sql = "SELECT age, email, phone, address, language 
                  FROM info";
          $result = mysqli_query($conn, $sql);
          if(mysqli_num_rows($result)>0){
            $post_list = mysqli_fetch_all($result);
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <?php
                echo '<div class="col-sm-8">'.$post[0].'</div>';
              ?>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Email:</strong></div>
              <?php
                echo '<div class="col-sm-8">'.$post[1].'</div>'
              ?>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <?php
                echo '<div class="col-sm-8">'.$post[2].'</div>'
              ?>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <?php
                echo '<div class="col-sm-8">'.$post[3].'</div>'
              ?>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <?php
                echo '<div class="col-sm-8">'.$post[4].'</div>'
              ?>
            </div>
          </div>
        </div>
  ...
  <div class="container">
    ...
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        ...
        <?php
          include('connectdb.php');
          $sql = "SELECT html, css, javascript, sass, bootstrap, photoshop 
                  FROM skill";
          $result = mysqli_query($conn, $sql);
          if(mysqli_num_rows($result)>0){
            $post_list = mysqli_fetch_all($result);
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">HTML</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $post[0] ?>%;"></div><span class="progress-value"><?php echo $post[0] ?>%</span>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">CSS</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $post[1] ?>%;"></div><span class="progress-value"><?php echo $post[1] ?>%</span>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">JavaScript</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $post[2] ?>%;"></div><span class="progress-value"><?php echo $post[2] ?>%</span>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">SASS</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $post[3] ?>%;"></div><span class="progress-value"><?php echo $post[3] ?>%</span>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Bootstrap</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $post[4] ?>%;"></div><span class="progress-value"><?php echo $post[4] ?>%</span>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Photoshop</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $post[5] ?>%;"></div><span class="progress-value"><?php echo $post[5] ?>%</span>
              </div>
            </div>
          </div>
        </div>
...
<div class="section" id="experience">
  <div class="container cc-experience">
    ...
    <?php
      include('connectdb.php');
      $sql = "SELECT work_1.w_id, work_1.d_id, wname, wrole, wabout, wdate
              FROM work_1,work_2,work_3
              WHERE work_1.w_id = work_2.w_id and work_1.d_id = work_3.d_id";
      $result = mysqli_query($conn, $sql);
      if(mysqli_num_rows($result)>0){
        $post_list = mysqli_fetch_all($result);
      }
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            <p><?php echo $post[5] ?></p>
            <div class="h5"><?php echo $post[2] ?></div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5"><?php echo $post[3] ?></div>
            <p><?php echo $post[4] ?></p>
          </div>
        </div>
      </div>
...
<div class="section">
  <div class="container cc-education">
        <?php
          include('connectdb.php');
          $sql = "SELECT ename, edate, eabout1, eabout2, eabout3
                  FROM education";
          $result = mysqli_query($conn, $sql);
          if(mysqli_num_rows($result)>0){
            $post_list = mysqli_fetch_all($result);
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <?php
              echo '<div class="h5">'.$post[2].'</div>';
              echo '<p class="category">'.$post[3].'</p>';
              echo '<p>'.$post[4].'</p>';
            ?>
          </div>
        </div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png')">
          ...
          <div class="col-md-9">
            <div class="card mb-0" data-aos="zoom-in">
              ...
              <div class="row">
                ...
                <?php
                  include('connectdb.php');
                  $sql = "SELECT address, phone, email
                          FROM info";
                  $result = mysqli_query($conn, $sql);
                  if(mysqli_num_rows($result)>0){
                    $post_list = mysqli_fetch_all($result);
                  ...
                  <div class="card-body">
                    ...
                    <p class="pb-2"><?php echo $post[0] ?></p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2"><?php echo $post[1] ?></p>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Vu Viet Anh Tu</div>
